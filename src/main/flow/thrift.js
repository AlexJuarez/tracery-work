// IMPORTANT!
// This file was manually ported from the TypeScript for Thrift 0.9.3, found here:
// https://github.com/apache/thrift/blob/6d9a3ca7d912482fb1321efae80a07eff9de2b85/lib/ts/thrift.d.ts
//
// If we ever upgrade thrift.js, we must port this file from the latest version.
...
declare module thrift {
   ...
   */
  declare class Transport extends TXHRTransport { }
  ...
  declare class TJSONProtocol {
     ...
     */
    constructor(transport: Object): void;
   ...
   * Old alias of the TXHRTransport for backwards compatibility.
   */
  declare class Protocol extends TJSONProtocol { }

  declare class MultiplexProtocol extends TJSONProtocol {
    serviceName: string;
     ...
     */
    constructor(srvName: string, trans: Object, strictRead?: any, strictWrite?: any): void;
